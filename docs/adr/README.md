...
| [ADR-002](./ADR-002-api-response-envelope.md) | API 回應採用 ApiResponse 信封格式 | Superseded by ADR-004 |
| [ADR-003](./ADR-003-refresh-token-rotation.md) | Refresh Token Rotation + 重用偵測 | Accepted |
| [ADR-004](./ADR-004-rfc7807-problem-details.md) | API 回應改用 HTTP 原生格式 + RFC 7807 Problem Details | Accepted |
| [ADR-005](./ADR-005-testcontainers-for-integration-tests.md) | 整合測試使用 Testcontainers 連真實 SQL Server | Accepted |
